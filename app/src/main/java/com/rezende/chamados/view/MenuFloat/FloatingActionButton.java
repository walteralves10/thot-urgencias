...
public class FloatingActionButton extends FrameLayout {
    ...
    public   float idY=-1, idBt=-1;
     public boolean emclick=false;
    public float mY=-1;
    ...
    public void setFloatingActionButtonDrawable(Drawable FloatingActionButtonDrawable) {
        mBitmap = cv(FloatingActionButtonDrawable);
        invalidate();
    }
    public Bitmap cv(Drawable drawable){
    ...
    public void init(int FloatingActionButtonColor) {
        ...
        }catch(Exception ignored){}catch (Error e) {
    ...
    static public class Builder {
        ...
        int gravity = Gravity.TOP | Gravity.RIGHT; // default bottom right
        Drawable drawable;
